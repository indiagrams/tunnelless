...
//
// Run via:
//   xcodebuild test -project app/TailnetDemo.xcodeproj \
//     -scheme TailnetDemo-iOS -destination 'platform=iOS Simulator,name=iPhone 16 Plus,OS=latest'
//
// CI runs this on every PR via .github/workflows/pr.yml.

import XCTest

final class TailnetDemoTests: XCTestCase {
    func testSmoke() {
