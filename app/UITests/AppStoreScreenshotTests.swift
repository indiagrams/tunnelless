...
// is compiled into BOTH the main app target (Tunnelless-iOS) and this UI test
...
///     TunnellessUITests/AppStoreScreenshotTests/testLightMode` when iterating.
///
...
final class AppStoreScreenshotTests: XCTestCase {
    ...
    private func launchAndCapture(appearance: XCUIDevice.Appearance, label: String) {
        ...
        // mode to Light"). TunnellessMain reads `-UITestColorScheme` at App
